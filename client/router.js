...
Router.map(function () {
    ...
    this.route('/fabLed', function () {
        routePublic(this, 'fabLed');
    });
    this.route('/fabAssembly', function () {
        routePublic(this, 'fabAssembly');
    });
    this.route('/fabJasper', function () {
        routePublic(this, 'fabJasper');
    });
